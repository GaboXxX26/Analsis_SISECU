        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Tabla Indicadores</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="../includes/procesar_centro.php" method="POST">
                        <table id="example2" class="table table-bordered table-hover table-responsive">
                            ...
                            <tr>
                                ...
                                <td> <input id=" conve_stra_2" name="conve_stra_2" type="number" class="form-control " style="width: 100%;" min="0" max="10" step="0.1" readonly>
                                </td>
