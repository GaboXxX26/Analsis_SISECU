...
if (isset($_POST['registrar'])) {
    ...
    if (
        preg_match('/^\d{10}$/', $_POST['telefono'])
        && preg_match('/^\d{10}$/', $_POST['dni'])
        ...
        $consulta = "INSERT INTO public.user ( nombre, apellido, correo, telefono, dni, genero, direccion, fecha_nacimiento, password, rol_id, id_centro, estado) 
        VALUES (:nombre, :apellido, :correo, :telefono, :dni, :genero, :direccion, :fecha_nacimiento, :encryptedPassword,:rol_id, :id_centro, :estado)";
